...
async fn main() {
    ...
    let skin2 = {
        let font = load_ttf_font("../ui_assets/MinimalPixel v2.ttf")
            .await
            .unwrap();
        let label_style = root_ui()
            .style_builder()
        ...
        let window_style = root_ui()
            ...
            .background(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/window_background_2.png"),
                    None,
                )
                .unwrap(),
            )
        ...
        let button_style = root_ui()
            ...
            .background(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/button_background_2.png"),
                    None,
                )
                .unwrap(),
            )
            ...
            .background_hovered(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/button_hovered_background_2.png"),
                    None,
                )
                .unwrap(),
            )
            .background_clicked(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/button_clicked_background_2.png"),
                    None,
                )
                .unwrap(),
            )
        ...
        let checkbox_style = root_ui()
            ...
            .background(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/checkbox_background.png"),
                    None,
                )
                .unwrap(),
            )
            .background_hovered(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/checkbox_hovered_background.png"),
                    None,
                )
                .unwrap(),
            )
            .background_clicked(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/checkbox_clicked_background.png"),
                    None,
                )
                .unwrap(),
            )
        ...
        let editbox_style = root_ui()
            ...
            .background(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/editbox_background.png"),
                    None,
                )
                .unwrap(),
            )
            .background_margin(RectOffset::new(2., 2., 30., 0.))
            .with_font(&font)
            .unwrap()
            .text_color(Color::from_rgba(120, 120, 120, 255))
            .font_size(25)
        ...
        let combobox_style = root_ui()
            ...
            .background(
                Image::from_file_with_format(
                    include_bytes!("../ui_assets/combobox_background.png"),
                    None,
                )
                .unwrap(),
            )
